...
Документ намеренно не угадывает уже изученное. Исходный уровень выставляется по фактически пройденным Core и
решениям в смешанных контестах, после чего карта показывает готовность по каждой теме.
