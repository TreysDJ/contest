...
| --: | ------------------------------ | :-------: | :-----------: |
|   1 | Сложность и Java               |     A     |       0       |
|   2 | Перебор и отсечения            |     A     |       0       |
|   3 | Сортировка и compression       |     A     |       0       |
|   4 | Map/Set/частоты                |     A     |       0       |
|   5 | Stack/queue/deque/PQ           |     A     |       0       |
|   6 | Prefix/difference/2D/sweep     |     A     |       0       |
|   7 | Two pointers/window            |     A     |       0       |
|   8 | Binary/ternary search          |     A     |       0       |
|   9 | Greedy                         |     A     |       0       |
|  10 | Биты и маски                   |     A     |       0       |
|  11 | Теория чисел                   |     A     |       0       |
|  12 | Модуль и комбинаторика         |     A     |       0       |
|  13 | Базовые строки                 |     A     |       0       |
|  14 | Базовые графы                  |     A     |       0       |
|  15 | Кратчайшие пути                |     A     |       0       |
|  16 | Деревья и LCA                  |     A     |       0       |
|  17 | Базовое DP                     |     A     |       0       |
|  18 | Fenwick/segment/lazy/sparse    |     A     |       0       |
|  19 | Геометрия                      |     B     |       0       |
...
- темы `A` — преимущественно уровень `3`, ключевые темы постепенно закрепляются на `4`;
- темы `B` — уровень `1–2`;
- темы `C` допустимо оставить на `0`, если они не нужны для конкретной олимпиады.

После прохождения отборов:

- темы `A` закрепляются на уровне `4`;
